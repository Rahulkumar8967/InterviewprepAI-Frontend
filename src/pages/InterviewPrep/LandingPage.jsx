...
const LandingPage = () => {
  ...
  return (
    <>
      ...
      <div className="w-full min-h-full relative z-10 mb-52">
        <div>
        ...
        <div className="text-sm bg-gray-50 text-secondary text-center p-5 mt-5">Made By ❤️ .. Rahul Kumar Saini</div>
      </div>
